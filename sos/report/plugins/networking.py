...
class Networking(Plugin):
    ...
    def setup(self):
        ...
        self.add_copy_spec([
            ...
            "/sys/class/net/*/device/class",
            "/sys/class/net/*/device/config",
            "/sys/class/net/*/device/numa_node",
            "/sys/class/net/*/device/local_cpulist",
            "/sys/class/net/*/device/irq",
            "/sys/class/net/*/device/enable",
            "/sys/class/net/*/device/current_link_speed",
            "/sys/class/net/*/device/current_link_width",
            "/sys/class/net/*/device/max_link_speed",
            "/sys/class/net/*/device/max_link_width",
            "/sys/class/net/*/device/sriov_numvfs",
            "/sys/class/net/*/device/sriov_totalvfs",
            "/sys/class/net/*/device/modalias",
